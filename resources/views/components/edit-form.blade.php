        <!--Show the errors-->
        @if ($errors->any())
            <div class="border-2 border-style: solid; border-red-500 mb-5 rounded-md">
                <ul class="list-disc p-2 text-red-500 font-semibold"> Error:
        ...
        <div>
            <form action="{{ route($action . '.update', $record->id) }}" method="POST" class="w-full max-w-sm">
                ...
                @if ($action == 'spendings')
                    <label for="bank"
                        class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4 pt-5">Bank:</label>
                    <input
                        class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                ...
                <label for="amount"
                    class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4 pt-5">Amount:</label>
                <input
                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
